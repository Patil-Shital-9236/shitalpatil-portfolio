...
const CustomCursor: React.FC<{ isHovered: boolean }> = ({ isHovered }) => {
    ...
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-end">
        <video
          ...
          loop
          playsInline
          className="w-full h-full object-cover md:h-screen md:w-auto md:max-w-none md:object-contain origin-center md:origin-right scale-100 md:scale-[0.98] lg:scale-100 opacity-90 contrast-[1.05] saturate-[1.05]"
        >
